...
SET_FIELD_PTR_GC(RealPort, RealPort, this, value, field_tmp_3);
...
/* Fmi.vdmrt 81:26 */
TVP ret_7 = vdmCloneGC(GET_FIELD_PTR_GC(RealPort, RealPort, this, value), &ret_7)
;
/* Fmi.vdmrt 81:19 */
return ret_7;
}
