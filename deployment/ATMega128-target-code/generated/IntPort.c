...
/* Fmi.vdmrt 44:27 */
TVP field_tmp_1 = vdmCloneGC(v, &field_tmp_1)
;

SET_FIELD_PTR_GC(IntPort, IntPort, this, value, field_tmp_1);
...
/* Fmi.vdmrt 47:26 */
TVP ret_3 = vdmCloneGC(GET_FIELD_PTR_GC(IntPort, IntPort, this, value), &ret_3)
;
/* Fmi.vdmrt 47:19 */
return ret_3;
}
...
IntPortCLASS IntPort_Constructor(IntPortCLASS this_ptr)
{
	...
	if(this_ptr!=NULL)
	{
		...
		this_ptr->_IntPort_pVTable=VTableArrayForIntPort;
				...
				this_ptr->m_IntPort_value= _Z17fieldInitializer2EV();
			}
